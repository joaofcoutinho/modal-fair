...
const beneficios = [
  { icon: Eye,       titulo: "Alta Visibilidade",      descricao: "Seu estande no centro do maior evento de logística e portos de Aracruz." },
  { icon: Users,     titulo: "500+ Visitantes/dia",    descricao: "Acesso direto a decisores e empresas do comércio exterior capixaba." },
  { icon: TrendingUp,titulo: "Geração de Negócios",    descricao: "Ambiente propício para fechar contratos e expandir sua carteira de clientes." },
  { icon: Store,     titulo: "Presença de Marca",      descricao: "3 dias de visibilidade para o público mais qualificado do setor no ES." },
];
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-px mb-16" style={{ background: "rgba(255,255,255,0.07)" }}>
          {beneficios.map((b, i) => (
            <div key={i} className="p-8 flex flex-col gap-4" style={{ background: "#141414" }}>
              <b.icon size={18} className="text-white/70" />
              <h3 className="text-white font-semibold text-sm">{b.titulo}</h3>
